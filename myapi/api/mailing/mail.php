...
try {
    ...
    $mail->Subject = 'شكرا لإشتراكك في قائمتنا البريدية';
    $mail->Body    =   '<b> الجوري للتدريب واللغات يرحب بك </b>
  سوف تصلك كل العروض الخاصة بالدورات التدريبية<br>'
  .$emailTitle.  ' <br>
  لمزيد من المعلومات يمكنك التواصل معنا عبر <br> 
  info@aljory.net <br>
  aljourycenter@gmail.com<br>
  +249 91 756 5129‬ <br> 
  ‎‪+24915 540 8127  ';
