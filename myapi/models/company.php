...
public function getInvoiceDetails(){
  ...
  // Clean data
  $this->arName = htmlspecialchars(strip_tags($this->arName));
  $this->engName = htmlspecialchars(strip_tags($this->engName));
  ...
  // Bind data
  $stmt-> bindParam(':arName', $this->arName);
  $stmt-> bindParam(':engName', $this->engName);
