    ...
    public function readByStore(){
     ...
     public function readTop(){
      ...
      jdetails_from.id,
        ...
        jdetails_from.j_ref,
        jdetails_from.ac_id,
        jdetails_from.j_type,
        jdetails_from.credit,
        jdetails_from.store_id,
        jdetails_from.debit,
        journal.j_date,
        journal.j_desc,
         ...
         journal.j_details,
          ...
          INNER JOIN journal ON jdetails_from.j_ref = journal.j_ref
          WHERE 
          jdetails_from.store_id = :store_id  AND jdetails_from.yearId =:yearId 
          ORDER BY
          journal.j_date  DESC
          ';
      ...
      jdetails_from.id,
        ...
        journal.j_desc,
         ...
         journal.j_details,
          ...
          INNER JOIN journal ON jdetails_from.j_ref = journal.j_ref
          WHERE 
         journal.j_date = :from AND jdetails_from.store_id = :store_id  AND jdetails_from.yearId =:yearId
          ORDER BY
         journal.j_date  DESC
          ';
      ...
      jdetails_from.id,
        ...
        journal.j_desc,
         ...
         journal.j_details,
          ...
          INNER JOIN journal ON jdetails_from.j_ref = journal.j_ref
          WHERE 
         journal.j_date >= :from AND journal.j_date <= :to AND jdetails_from.store_id = :store_id  AND jdetails_from.yearId =:yearId
          ORDER BY
          journal.j_date  DESC
          ';
        ...
        store_id,
         yearId
          FROM
           ' . $this->table . ' 
          WHERE 
          store_id = :store_id  AND j_date != 1  AND j_date != 2 AND yearId =:yearId
          ORDER BY
          id ASC
          ';
